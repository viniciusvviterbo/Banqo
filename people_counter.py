...
ct = CentroidTracker(maxDisappeared=25, maxDistance=50) # Inicializa uma instância do rastreador de centróides, considerando um objeto não detectado por mais de 20 quadros como desaparecido 
